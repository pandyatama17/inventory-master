function getSupplierDetails(str)
{
   ...
   xhttp.onreadystatechange = function()
   {
      if (xhttp.readyState == 4 && xhttp.status == 200)
      {
         ...
         console.log("----------------------------");
         document.getElementById("supplier_address").innerHTML = responseText.address;
      }
   };
   xhttp.open("GET", "/supplier/supplierAsJSON/"+str, true);
   xhttp.send();
}
...
function getItem(str, row)
{
   ...
   xhttp.onreadystatechange = function()
   {
      if (xhttp.readyState == 4 && xhttp.status == 200)
      {
         ...
         $("#itemPriceCol"+row).html(rupiah(responseText.supplier_price));
