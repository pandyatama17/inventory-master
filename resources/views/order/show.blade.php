  ...
  <script src="{{asset('js/plugins/printarea/jquery.PrintArea.js')}}" type="text/JavaScript" language="javascript"></script>
   <div class="row white-bg" id="printarea">
      ...
      <div class="col-xs-4">
         <table>
            <tr>
               <td style="padding-right:15px; padding-top:5px; padding-bottom:3px">PO # </td>
               <td>&nbsp;:&nbsp;</td>
            ...
            <tr>
               <td style="padding-right:15px; padding-top:5px; padding-bottom:3px">Tanggal PO </td>
               <td>&nbsp;:&nbsp;</td>
               <td style="padding-left:15px; padding-right:15px padding-top:3px; padding-bottom:3px">
                 {{$order->order_date}}
               </td>
         ...
         <table>
            ...
            <tr>
               <td style="padding-top:5px;">
                 {{DB::table('suppliers')->where('id', $order->supplier_id)->pluck('name')[0]}}
               </td>
            </tr>
            <tr>
               <td style="padding-top:5px;">
                  {{DB::table('suppliers')->where('id', $order->supplier_id)->pluck('address')[0]}}
               </td>
            </tr>
         </table>
      </div>
            ...
            <tfoot>
              <th class="table-menu">
                ...
                <td style="border-top:2px solid lightgrey">
                  <span id="totalcost" class="pull-right lead">Rp. {{number_format($order->total,2,',','.')}}</span>
                </td>
              </th>
            </tfoot>
         </table>
